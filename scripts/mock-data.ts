...
// 3 months of history — enough for meaningful charts
// ===========================================
export const mockTransactions = [
  // --- November 2024 ---
  {
    id: 'tx-n1',
    name: 'Hyresbetalning November',
    date: '2024-11-01',
    amount: '-15 000,00 kr',
    amountValue: -15000,
  ...
  {
    id: 'tx-n2',
    name: 'Nordea Bank - Ränteintäkt',
    date: '2024-11-03',
    amount: '+1 240,00 kr',
    amountValue: 1240,
    status: TRANSACTION_STATUSES.RECORDED,
    account: 'Sparkonto',
    category: 'Finansiella intäkter',
    type: 'income',
  },
  {
    id: 'tx-n3',
    name: 'Konsult AB - Faktura 2024-078',
    date: '2024-11-05',
    amount: '+87 500,00 kr',
    amountValue: 87500,
    status: TRANSACTION_STATUSES.RECORDED,
  ...
  {
    id: 'tx-n7',
    name: 'Tech Partner AB - Faktura 2024-081',
    date: '2024-11-18',
    amount: '+45 000,00 kr',
    amountValue: 45000,
    status: TRANSACTION_STATUSES.RECORDED,
  ...
  {
    id: 'tx-d6',
    name: 'Kontorsmaterial Elgiganten',
    date: '2024-12-10',
    amount: '-3 890,00 kr',
    amountValue: -3890,
    status: TRANSACTION_STATUSES.UNBOOKED,
    account: 'Företagskonto',
  ...
  {
    id: 'tx-j5',
    name: 'Stort Företag AB - Faktura 2025-002',
    date: '2025-01-13',
    amount: '+125 000,00 kr',
    amountValue: 125000,
    status: TRANSACTION_STATUSES.RECORDED,
...
// ===========================================
// EMPLOYEES (Löner > Team)
// Full DB-compatible fields — personal_number, kommun, tax_table etc.
// ===========================================
export const mockEmployees = [
  {
    ...
    phone: '070-123 45 67',
    personal_number: '198501152345',
    monthly_salary: 75000,
    employment_type: 'Tillsvidare',
    tax_rate: 0.3066,       // Stockholm kommunalskatt
    tax_table: 32,
    tax_column: 1,
    kommun: 'Stockholm',
    status: 'active',
  ...
  },
  {
    ...
    phone: '073-345 67 89',
    personal_number: '199205103456',
    monthly_salary: 50000,
    employment_type: 'Tillsvidare',
    tax_rate: 0.3235,       // Göteborg kommunalskatt
    tax_table: 33,
    tax_column: 1,
    kommun: 'Göteborg',
    status: 'active',
  ...
  },
  {
    ...
    phone: '076-456 78 90',
    personal_number: '198812254567',
    monthly_salary: 45000,
    employment_type: 'Tillsvidare',
    tax_rate: 0.3242,       // Uppsala kommunalskatt
    tax_table: 33,
    tax_column: 1,
    kommun: 'Uppsala',
    status: 'active',
