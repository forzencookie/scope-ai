...
// src/app/page.tsx
import {
  Navbar, Hero, Stats, FeaturePitch, CoreFeatures, GlobalReach,
  Pricing, FAQ, Contact, Footer, AnimatedDitherArt,
...
- [ ] Remove Three.js dependencies and orb.tsx
- [ ] Convert useVerifications to React Query with proper caching
- [ ] Remove duplicate CompanyProvider from layout
- [ ] Add useMemo to all 4 context providers
- [ ] Add AbortController to fetch hooks
- [ ] Dynamic import dashboard page components
- [ ] Add React.memo to list item components
- [ ] Fix index-as-key issues (use unique IDs)
- [ ] Add cleanup functions to useEffect hooks
- [ ] Convert remaining hooks to useCachedQuery
- [ ] Parallelize compliance API fetches
