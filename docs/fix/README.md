...
> Each file maps 1:1 to a flow doc in `docs/flows/`.
> Read the flow (vision) first, then read the fix (what to build/change to get there).
> Flag anything suspicious or potentially redundant for founder review.
