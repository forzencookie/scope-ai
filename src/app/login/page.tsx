  ...
  return (
    <div className="light min-h-screen bg-white p-6 flex items-center justify-center">
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-11 gap-8">
        ...
        {/* Right: Login Form (45%, plain background) */}
        <div className="lg:col-span-5 flex flex-col justify-center px-4 lg:px-12">
          <div className="w-full max-w-sm mx-auto">

            {/* Header */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-stone-900 mb-1">Logga in</h2>
              <p className="text-sm text-stone-500">Välkommen tillbaka</p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-stone-500">
              Har du inget konto?{' '}
              <a href="/register" className="font-medium text-stone-900 hover:underline">
                Skapa konto
              </a>
            </p>
          </div>
