      ...
      <div className="w-full max-w-md">
        <Card className="border-0 shadow-xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardTitle className="text-2xl font-bold">Laddar...</CardTitle>
          </CardHeader>
...
function LoginContent() {
  ...
  const { signIn, signInWithOAuth, isAuthenticated, loading: authLoading } = useAuth()
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Automatiserad bokföring för AB, EF, HB, KB och ideella föreningar. 
            Med AI-stöd och BAS-kontoplan.
          </p>
          ...
          <ul className="space-y-3 text-white/90">
            <li className="flex items-center gap-2">
              ...
              Stöd för alla svenska bolagsformer
            </li>
            <li className="flex items-center gap-2">
              <div className="h-5 w-5 rounded-full bg-white/20 flex items-center justify-center">
                <ArrowRight className="h-3 w-3" />
