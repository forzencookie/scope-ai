...
// Årsbokslut content (for EF, HB, KB - simplified annual accounts)
function ArsbokslutContent() {
        ...
        <main className="flex-1 flex flex-col px-6 pt-2 pb-6">
            <div className="max-w-6xl w-full space-y-6">
                ...
                <SectionCard
                    ...
                    variant="ai"
                    action={
                        <button className="px-4 py-2 rounded-lg font-medium bg-white dark:bg-purple-900/60 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-800/50 transition-colors text-sm">
                            Generera
                        </button>
                    }
                />
                ...
                <DataTable title="Resultaträkning (förenklad)">
                    ...
                    <DataTableBody>
                        <DataTableRow>
                            <DataTableCell bold>Försäljning och övriga intäkter</DataTableCell>
                            <DataTableCell align="right">485 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell>Varor, material och tjänster</DataTableCell>
                            <DataTableCell align="right">-125 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell>Övriga externa kostnader</DataTableCell>
                            <DataTableCell align="right">-85 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell>Personalkostnader</DataTableCell>
                            <DataTableCell align="right">-0 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell>Avskrivningar</DataTableCell>
                            <DataTableCell align="right">-15 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow className="border-t-2">
                            <DataTableCell bold>Årets resultat</DataTableCell>
                            <DataTableCell align="right" bold>260 000 kr</DataTableCell>
                        </DataTableRow>
                    </DataTableBody>
                </DataTable>
                ...
                <DataTable title="Balansräkning (förenklad)">
                    ...
                    <DataTableBody>
                        <DataTableRow>
                            <DataTableCell bold>Tillgångar</DataTableCell>
                            <DataTableCell align="right" bold>385 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Inventarier</DataTableCell>
                            <DataTableCell align="right">45 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Kundfordringar</DataTableCell>
                            <DataTableCell align="right">62 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Kassa och bank</DataTableCell>
                            <DataTableCell align="right">278 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow className="border-t">
                            <DataTableCell bold>Eget kapital och skulder</DataTableCell>
                            <DataTableCell align="right" bold>385 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Eget kapital</DataTableCell>
                            <DataTableCell align="right">310 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Leverantörsskulder</DataTableCell>
                            <DataTableCell align="right">45 000 kr</DataTableCell>
                        </DataTableRow>
                        <DataTableRow>
                            <DataTableCell className="pl-6">Skatteskulder</DataTableCell>
                            <DataTableCell align="right">30 000 kr</DataTableCell>
                        </DataTableRow>
                    </DataTableBody>
                </DataTable>
            </div>
...
function ReportsPageContent() {
    ...
    const currentTabConfig = availableTabs.find(t => t.id === currentTab) || availableTabs[0]
