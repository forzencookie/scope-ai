                ...
                <div className="flex flex-col gap-2">
                    {filteredItems.map((item) => (
                        <div
                            ...
                            className={`flex items-center gap-3 p-4 rounded-lg border-2 transition-colors group cursor-pointer border-border/60 hover:bg-muted/30 ${!item.read ? "bg-muted/20" : ""}`}
                        >
                            {/* Content */}
