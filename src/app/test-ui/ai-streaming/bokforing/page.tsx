...
const pages = [
    { href: "/test-ui/ai-streaming/bokforing/transaktioner", label: "Transaktioner", icon: ArrowLeftRight, description: "Visa transaktioner · Bokför kvitto · Batch-bokföring" },
    { href: "/test-ui/ai-streaming/bokforing/fakturor", label: "Fakturor", icon: FileText, description: "Skapa faktura · Registrera betalning · Makulera" },
    { href: "/test-ui/ai-streaming/bokforing/verifikationer", label: "Verifikationer", icon: Hash, description: "Visa verifikationer · Makulera verifikation" },
    { href: "/test-ui/ai-streaming/bokforing/inventarier", label: "Inventarier", icon: Package, description: "Registrera inventarie · Kör avskrivning" },
]
