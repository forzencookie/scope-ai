...
const pages = [
    { href: "/test-ui/ai-streaming/rapporter/rapporter", label: "Rapporter & Deklarationer", icon: FileBarChart, description: "Resultaträkning · Balansräkning · Moms · AGI · K10 · Bokslut" },
]
