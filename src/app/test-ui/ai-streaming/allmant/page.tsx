...
const pages = [
    { href: "/test-ui/ai-streaming/allmant/kunskap", label: "Kunskapsfrågor", icon: Brain, description: "Hur fungerar utdelning? · Förklara BAS-kontoplanen · Vad är K10?" },
    { href: "/test-ui/ai-streaming/allmant/optimering", label: "Skatteoptimering & Rådgivning", icon: Lightbulb, description: "Optimera min skatt · Lön vs utdelning · Ska jag momsregistrera?" },
    { href: "/test-ui/ai-streaming/allmant/uppgifter", label: "Uppgifter & Påminnelser", icon: ListChecks, description: "Kom ihåg att… · Vad har jag kvar? · Onboarding" },
]
