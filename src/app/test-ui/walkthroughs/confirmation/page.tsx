...
function DomainCard({
    ...
    const iconStyles: Record<ConfirmationAccent, { iconColor: string; iconBg: string }> = {
                ...
                <div className="border-t pt-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Ny anställd" subtitle="Registrera i systemet" icon={User} accent="green" buttonLabel="Registrera">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Ny ägare" subtitle="Registrera i aktiebok" icon={Landmark} accent="purple" buttonLabel="Registrera">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Ny delägare" subtitle="Registrera i bolagsavtal" icon={Users} accent="purple" buttonLabel="Registrera">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Ny medlem" subtitle="Registrera i medlemsregister" icon={Users} accent="green" buttonLabel="Registrera">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Ny kund" subtitle="Lägg till i kundregister" icon={Building2} accent="teal" buttonLabel="Lägg till">
                            ...
                            <div className="max-w-lg">
                                <div className="w-full max-w-md space-y-1 py-1">
                                    <div className="flex items-center gap-2.5 mb-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold">Utdelningsbeslut 2025</p>
                                    ...
                                    <div className="flex gap-2 pt-3">
                                        <Button size="sm" >Besluta utdelning</Button>
                                        <Button variant="ghost" size="sm">Avbryt</Button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Bokför utdelning 2025" subtitle="Scope AI AB" icon={Coins} accent="amber" buttonLabel="Bokför utdelning">
                                    <SummaryRow label="Total utdelning" value={formatCurrency(150000)} />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Aktieöverlåtelse" subtitle="Scope AI AB" icon={ArrowRight} accent="purple" buttonLabel="Genomför överlåtelse">
                            ...
                            <div className="max-w-lg">
                                <div className="w-full max-w-md space-y-1 py-1">
                                    <div className="flex items-center gap-2.5 mb-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold">Eget uttag</p>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Tilldela roll" subtitle="Styrelsepost" icon={Gavel} accent="indigo" buttonLabel="Tilldela">
                                    <IconRow icon={User} bold>Maria Johansson</IconRow>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="max-w-lg">
                                <DomainCard title="Nytt styrelsemöte" subtitle="Möte 4/2026" icon={Calendar} accent="indigo" buttonLabel="Skapa möte">
                            ...
                            <div className="max-w-lg">
                                <div className="w-full max-w-md space-y-1 py-1">
                                    <div className="flex items-center gap-2.5 mb-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold">Bokför 4 kvitton</p>
                                            <p className="text-xs text-muted-foreground">Granska innan bokföring</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-2 pt-2">
                                        <Button size="sm">Bokför alla (4)</Button>
                                        <Button variant="ghost" size="sm">Avbryt</Button>
                                    </div>
                                </div>
                            </div>
