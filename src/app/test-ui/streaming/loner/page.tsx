...
const pages = [
    { href: "/test-ui/streaming/loner/lonekorning", label: "Lönekörning", icon: Coins, description: "Kör lönerna · Löneberäkning · AGI-koppling" },
    { href: "/test-ui/streaming/loner/team", label: "Team", icon: Users, description: "Lägg till anställd · Visa teamet · Uppdatera uppgifter" },
    { href: "/test-ui/streaming/loner/formaner", label: "Förmåner", icon: Gift, description: "Tilldela förmån · Friskvårdsbidrag · Tjänstebil" },
    { href: "/test-ui/streaming/loner/egenavgifter", label: "Egenavgifter", icon: Calculator, description: "Beräkna egenavgifter · Skattejustering", badges: ["EF"] },
    { href: "/test-ui/streaming/loner/delagaruttag", label: "Delägaruttag", icon: Wallet, description: "Registrera uttag · Periodöversikt", badges: ["HB", "KB"] },
]
