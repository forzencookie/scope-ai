...
import { ActionConfirmCard, completedActionConfig, type ConfirmationAccent, type CompletedAction } from "@/components/ai/cards/action-cards/action-confirm-card"
import { EntityUpdateCard } from "@/components/ai/cards/action-cards/entity-update-card"
import { ChecklistConfirmCard } from "@/components/ai/cards/action-cards/checklist-confirm-card"
...
const genericConfirmations: Array<{
    ...
    {
        label: "Tilldela friskvårdsbidrag",
        description: "AB, HB — skattefri förmån",
        companyTypes: "AB, HB",
    ...
    {
        label: "Bokför milersättning",
        description: "Alla — privat bil i tjänsten",
        companyTypes: "Alla",
        confirmLabel: "Bokför",
        icon: Receipt,
        accent: "blue",
        ...
        subtitle: "Kundbesök Göteborg — 150 km",
        properties: [
    ...
    {
        label: "Bokför julgåvor",
        description: "Alla — ≤ 550 kr/person skattefritt",
        companyTypes: "Alla",
        confirmLabel: "Bokför",
        icon: Gift,
        accent: "green",
        ...
        subtitle: "4 anställda · 500 kr/person",
        properties: [
    ...
    {
        label: "Bokför personalvård",
        description: "Alla — fika/frukt skattefritt utan gräns",
        companyTypes: "Alla",
        confirmLabel: "Bokför",
        icon: Receipt,
        accent: "green",
    ...
    {
        label: "Schemalägg styrelsemöte",
        description: "AB — åtgärder som kräver styrelsebeslut",
        companyTypes: "AB",
        confirmLabel: "Schemalägg + generera protokoll",
        icon: Gavel,
        accent: "indigo",
        completedAction: "created",
        completedTitle: "Styrelsemöte schemalagt",
        title: "Styrelsemöte",
        subtitle: "Antagande av årsredovisning 2025",
        properties: [
            { label: "Typ", value: "Styrelsemöte" },
            { label: "Datum", value: "2026-04-28" },
            { label: "Ordförande", value: "Anders Richnau" },
            { label: "Dagordning", value: "Anta årsredovisning 2025" },
            { label: "Dokument", value: "Styrelsemötesprotokoll (PDF)" },
        ],
    },
    {
        label: "Styrelsebeslut — utse VD",
        description: "AB — VD utses av styrelsen, ej stämman",
        companyTypes: "AB",
        ...
        subtitle: "Sara Ek · Startdatum 1 juni 2026",
        properties: [
    ...
    {
        label: "Styrelsebeslut — godkänn avtal",
        description: "AB — väsentliga åtaganden kräver styrelsebeslut",
        companyTypes: "AB",
        confirmLabel: "Fatta beslut + generera protokoll",
        icon: FileText,
        accent: "blue",
        ...
        subtitle: "Kungsgatan 12 · 60 000 kr/mån · 3 år",
        properties: [
