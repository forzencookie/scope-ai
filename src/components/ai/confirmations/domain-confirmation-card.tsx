...
import { completedActionConfig, type ConfirmationAccent, type CompletedAction } from "./generic-confirmation-card"
...
export interface DomainConfirmationCardProps {
    title: string | null
...
export function DomainConfirmationCard({
    title,
    subtitle,
