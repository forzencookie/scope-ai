...
export function AISuggestionsBanner({ 
    ...
    return (
        <div className="flex items-center justify-between py-2 px-3 bg-gradient-to-r from-violet-50 to-blue-50 dark:from-violet-950/50 dark:to-blue-950/50 rounded-lg border border-violet-100 dark:border-violet-800/50">
