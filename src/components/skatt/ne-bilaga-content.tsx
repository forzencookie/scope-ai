...
export function NEBilagaContent() {
    ...
    const adjustmentItems: Table2Item[] = [
            ...
            <main className="flex-1 flex flex-col p-6">
                <div className="max-w-6xl w-full space-y-6">
                    ...
                    <SectionCard
                        ...
                        variant="ai"
                        onAction={() => toast({ title: "AI-guide", description: "AI-guiden för NE-bilaga startas..." })}
