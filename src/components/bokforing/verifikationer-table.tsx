    ...
    return (
        <Table2Container>
            ...
            <Table2Header
                ...
                subtitle="Se alla bokförda transaktioner och verifikationer."
            >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                        <Button
                            variant="outline"
                            size="sm"
                            className={cn("h-9 gap-2", classFilter !== "all" && "border-primary text-primary")}
            ...
            {/* Custom Report-style Table Header */}
            <div className="grid grid-cols-12 gap-4 px-2 py-2 border-b border-border/60 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            ...
            <div className="space-y-0.5">
                {filteredVerifikationer.map((v) => (
                    <div
                        ...
                        className={cn(
                            "grid grid-cols-12 gap-4 px-2 py-3 hover:bg-muted/30 -mx-2 rounded-md transition-colors cursor-pointer items-center text-sm group",
                            selection.isSelected(String(v.id)) && "bg-muted/40"
                        )}
                    >
                        ...
                        <div className="col-span-2 text-right">
                            <span className={cn(
                                ...
                                {v.amount.toLocaleString('sv-SE')} kr
                            </span>
                        </div>
